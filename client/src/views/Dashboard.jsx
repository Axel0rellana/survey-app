...
//components
import { DashboardCard, PageComponent, TButton } from "../components";
            ...
            {data.latestSurvey && (
              <div>
                <img
                  ...
                  className="w-[240px] mx-auto select-none pointer-events-none"
                />
              ...
              <div className="text-left">
                {data.latestAnswers?.map((answer) => (
                  ...
                  >
                    ...
                    <small>
                      Answer Made at: <i className="font-semibold">{answer.end_date}</i>
                    </small>
                  </a>
                ))}
              </div>
